...
set midiCmd2 to sendmidiPath & " dev IAC Driver Bus 1 ch 4 cc 3 127" -- LED scene 1
set midiCmd3 to sendmidiPath & " dev IAC Driver Bus 1 ch 5 cc 3 127" -- Chasin Mix
